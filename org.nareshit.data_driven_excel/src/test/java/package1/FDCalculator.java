...
public class FDCalculator {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		for(int r=1;r<=eu.getRowCount(filePath, "Sheet1");r++)
		{
			...
			if(Double.parseDouble(exp_maturity_amount)==Double.parseDouble(act_maturity_amount))
			{
				System.out.println("Passed");
				eu.setCellData(filePath, "Sheet1", r, 7, "passed");
				eu.fillGreenColour(filePath, "Sheet1", r, 7);
			}
			else
			{
				System.out.println("Failed");
				eu.setCellData(filePath, "Sheet1", r, 7, "failed");
				eu.fillRedColour(filePath, "Sheet1", r, 7);
			}
			clear_btn.click();
